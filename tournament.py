...
from ex2.exceptions import InvalidBattleError
...
if __name__ == "__main__":
    ...
    battle([(flame_f, normal), (healing_f, defensive)])

    print("\nTournament 1 (error)")
    battle([(flame_f, aggressive), (healing_f, defensive)])

    print("\nTournament 2 (multiple)")
    battle([(aqua_f, normal), (healing_f, defensive), (transform_f, aggressive)])