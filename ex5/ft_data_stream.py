...
EventStream = Generator[tuple[str, str], Any, NoReturn]
...
def gen_event() -> EventStream:  # pyright: ignore[reportExplicitAny]
    while True:
...
def consume_event(events) -> Generator[Any, Any, None]:
    while (events):
